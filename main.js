function updateTime() {
  ...
  if(hours < 12){
    greetings.innerHTML = "Good Morning Laban!!!";
  }else if(hours == 12){
    greetings.innerHTML = "It's noon Laban!!!";
  }else if(hours < 16){
    greetings.innerHTML = "Good Afternoon Laban!!!";
  }else if(hours > 16){
    greetings.innerHTML = "Good Evening Laban!!!";
  }
...
thumbnails.forEach(thumbnail => {
   thumbnail.addEventListener('click', function() {
     // Change the source of the main gallery image to match the clicked thumbnail
